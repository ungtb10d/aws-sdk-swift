...
public protocol DynamodbClientProtocol {
     ...
     */
    func batchExecuteStatement(input: BatchExecuteStatementInput, completion: @escaping (SdkResult<BatchExecuteStatementOutput, BatchExecuteStatementError>) -> Void)
    /**
           ...
           items in your request in the <code>ProjectionExpression</code> parameter.</p>
              <p>If a requested item does not exist, it is not returned in the result. Requests for
                 ...
                 For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#CapacityUnitCalculations">Working with Tables</a> in the <i>Amazon DynamoDB Developer
                     Guide</i>.</p>
     */
    func batchGetItem(input: BatchGetItemInput, completion: @escaping (SdkResult<BatchGetItemOutput, BatchGetItemError>) -> Void)
    /**
     ...
     */
    func batchWriteItem(input: BatchWriteItemInput, completion: @escaping (SdkResult<BatchWriteItemOutput, BatchWriteItemError>) -> Void)
    /**
     ...
     */
    func createBackup(input: CreateBackupInput, completion: @escaping (SdkResult<CreateBackupOutput, CreateBackupError>) -> Void)
    /**
     ...
     */
    func createGlobalTable(input: CreateGlobalTableInput, completion: @escaping (SdkResult<CreateGlobalTableOutput, CreateGlobalTableError>) -> Void)
    /**
     ...
     */
    func createTable(input: CreateTableInput, completion: @escaping (SdkResult<CreateTableOutput, CreateTableError>) -> Void)
    /**
     ...
     */
    func deleteBackup(input: DeleteBackupInput, completion: @escaping (SdkResult<DeleteBackupOutput, DeleteBackupError>) -> Void)
    /**
     ...
     */
    func deleteItem(input: DeleteItemInput, completion: @escaping (SdkResult<DeleteItemOutput, DeleteItemError>) -> Void)
    /**
     ...
     */
    func deleteTable(input: DeleteTableInput, completion: @escaping (SdkResult<DeleteTableOutput, DeleteTableError>) -> Void)
    /**
     ...
     */
    func describeBackup(input: DescribeBackupInput, completion: @escaping (SdkResult<DescribeBackupOutput, DescribeBackupError>) -> Void)
    /**
     ...
     */
    func describeContinuousBackups(input: DescribeContinuousBackupsInput, completion: @escaping (SdkResult<DescribeContinuousBackupsOutput, DescribeContinuousBackupsError>) -> Void)
    /// <p>Returns information about contributor insights, for a given table or global secondary index.</p>
    func describeContributorInsights(input: DescribeContributorInsightsInput, completion: @escaping (SdkResult<DescribeContributorInsightsOutput, DescribeContributorInsightsError>) -> Void)
    /// <p>Returns the regional endpoint information.</p>
    func describeEndpoints(input: DescribeEndpointsInput, completion: @escaping (SdkResult<DescribeEndpointsOutput, DescribeEndpointsError>) -> Void)
    /// <p>Describes an existing table export.</p>
    func describeExport(input: DescribeExportInput, completion: @escaping (SdkResult<DescribeExportOutput, DescribeExportError>) -> Void)
    /**
     ...
     */
    func describeGlobalTable(input: DescribeGlobalTableInput, completion: @escaping (SdkResult<DescribeGlobalTableOutput, DescribeGlobalTableError>) -> Void)
    /**
     ...
     */
    func describeGlobalTableSettings(input: DescribeGlobalTableSettingsInput, completion: @escaping (SdkResult<DescribeGlobalTableSettingsOutput, DescribeGlobalTableSettingsError>) -> Void)
    /// <p>Returns information about the status of Kinesis streaming.</p>
    func describeKinesisStreamingDestination(input: DescribeKinesisStreamingDestinationInput, completion: @escaping (SdkResult<DescribeKinesisStreamingDestinationOutput, DescribeKinesisStreamingDestinationError>) -> Void)
    /**
     ...
     */
    func describeLimits(input: DescribeLimitsInput, completion: @escaping (SdkResult<DescribeLimitsOutput, DescribeLimitsError>) -> Void)
    /**
     ...
     */
    func describeTable(input: DescribeTableInput, completion: @escaping (SdkResult<DescribeTableOutput, DescribeTableError>) -> Void)
    /**
     ...
     */
    func describeTableReplicaAutoScaling(input: DescribeTableReplicaAutoScalingInput, completion: @escaping (SdkResult<DescribeTableReplicaAutoScalingOutput, DescribeTableReplicaAutoScalingError>) -> Void)
    /// <p>Gives a description of the Time to Live (TTL) status on the specified table. </p>
    func describeTimeToLive(input: DescribeTimeToLiveInput, completion: @escaping (SdkResult<DescribeTimeToLiveOutput, DescribeTimeToLiveError>) -> Void)
    /**
     ...
     */
    func disableKinesisStreamingDestination(input: DisableKinesisStreamingDestinationInput, completion: @escaping (SdkResult<DisableKinesisStreamingDestinationOutput, DisableKinesisStreamingDestinationError>) -> Void)
    /**
     <p>Starts table data replication to the specified Kinesis data stream at a timestamp chosen
                 ...
                 ACTIVE.</p>
     */
    func enableKinesisStreamingDestination(input: EnableKinesisStreamingDestinationInput, completion: @escaping (SdkResult<EnableKinesisStreamingDestinationOutput, EnableKinesisStreamingDestinationError>) -> Void)
    /**
     <p>
     This operation allows you to perform reads and singleton writes on data stored in DynamoDB, using PartiQL.
     </p>
     */
    func executeStatement(input: ExecuteStatementInput, completion: @escaping (SdkResult<ExecuteStatementOutput, ExecuteStatementError>) -> Void)
    /**
     <p>
     This operation allows you to perform transactional reads or writes on data stored in DynamoDB, using PartiQL.
     </p>
     */
    func executeTransaction(input: ExecuteTransactionInput, completion: @escaping (SdkResult<ExecuteTransactionOutput, ExecuteTransactionError>) -> Void)
    /**
     <p>Exports table data to an S3 bucket. The table must have point in time recovery
                 enabled, and you can export data from any time within the point in time recovery
                 window.</p>
     */
    func exportTableToPointInTime(input: ExportTableToPointInTimeInput, completion: @escaping (SdkResult<ExportTableToPointInTimeOutput, ExportTableToPointInTimeError>) -> Void)
    /**
     ...
     */
    func getItem(input: GetItemInput, completion: @escaping (SdkResult<GetItemOutput, GetItemError>) -> Void)
    /**
     ...
     */
    func listBackups(input: ListBackupsInput, completion: @escaping (SdkResult<ListBackupsOutput, ListBackupsError>) -> Void)
    /// <p>Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.</p>
    func listContributorInsights(input: ListContributorInsightsInput, completion: @escaping (SdkResult<ListContributorInsightsOutput, ListContributorInsightsError>) -> Void)
    /// <p>Lists completed exports within the past 90 days.</p>
    func listExports(input: ListExportsInput, completion: @escaping (SdkResult<ListExportsOutput, ListExportsError>) -> Void)
    /**
     ...
     */
    func listGlobalTables(input: ListGlobalTablesInput, completion: @escaping (SdkResult<ListGlobalTablesOutput, ListGlobalTablesError>) -> Void)
    /**
     <p>Returns an array of table names associated with the current account and endpoint. The output
           ...
           names.</p>
     */
    func listTables(input: ListTablesInput, completion: @escaping (SdkResult<ListTablesOutput, ListTablesError>) -> Void)
    /**
     ...
     */
    func listTagsOfResource(input: ListTagsOfResourceInput, completion: @escaping (SdkResult<ListTagsOfResourceOutput, ListTagsOfResourceError>) -> Void)
    /**
     ...
     */
    func putItem(input: PutItemInput, completion: @escaping (SdkResult<PutItemOutput, PutItemError>) -> Void)
    /**
     <p>The <code>Query</code> operation finds items based on primary key values.
             ...
             <p>You can query a table, a local secondary index, or a global secondary index. For a
                 ...
                 secondary index.</p>
     */
    func query(input: QueryInput, completion: @escaping (SdkResult<QueryOutput, QueryError>) -> Void)
    /**
     ...
     */
    func restoreTableFromBackup(input: RestoreTableFromBackupInput, completion: @escaping (SdkResult<RestoreTableFromBackupOutput, RestoreTableFromBackupError>) -> Void)
    /**
     ...
     */
    func restoreTableToPointInTime(input: RestoreTableToPointInTimeInput, completion: @escaping (SdkResult<RestoreTableToPointInTimeOutput, RestoreTableToPointInTimeError>) -> Void)
    /**
     ...
     */
    func scan(input: ScanInput, completion: @escaping (SdkResult<ScanOutput, ScanError>) -> Void)
    /**
     ...
     */
    func transactGetItems(input: TransactGetItemsInput, completion: @escaping (SdkResult<TransactGetItemsOutput, TransactGetItemsError>) -> Void)
    /**
     <p>
     ...
     */
    func transactWriteItems(input: TransactWriteItemsInput, completion: @escaping (SdkResult<TransactWriteItemsOutput, TransactWriteItemsError>) -> Void)
    /**
     ...
     */
    func updateContinuousBackups(input: UpdateContinuousBackupsInput, completion: @escaping (SdkResult<UpdateContinuousBackupsOutput, UpdateContinuousBackupsError>) -> Void)
    /// <p>Updates the status for contributor insights for a specific table or index.</p>
    func updateContributorInsights(input: UpdateContributorInsightsInput, completion: @escaping (SdkResult<UpdateContributorInsightsOutput, UpdateContributorInsightsError>) -> Void)
    /**
     ...
     */
    func updateGlobalTable(input: UpdateGlobalTableInput, completion: @escaping (SdkResult<UpdateGlobalTableOutput, UpdateGlobalTableError>) -> Void)
    /// <p>Updates settings for a global table.</p>
    func updateGlobalTableSettings(input: UpdateGlobalTableSettingsInput, completion: @escaping (SdkResult<UpdateGlobalTableSettingsOutput, UpdateGlobalTableSettingsError>) -> Void)
    /**
     <p>Edits an existing item's attributes, or adds a new item to the table if it does not already exist. You can put, delete, or add attribute values. You can also perform a conditional update on an existing item (insert a new attribute name-value pair if it doesn't exist, or replace an existing name-value pair if it has certain expected attribute values).</p>
           ...
           operation using the <code>ReturnValues</code> parameter.</p>
     */
    func updateItem(input: UpdateItemInput, completion: @escaping (SdkResult<UpdateItemOutput, UpdateItemError>) -> Void)
    /**
     ...
     */
    func updateTable(input: UpdateTableInput, completion: @escaping (SdkResult<UpdateTableOutput, UpdateTableError>) -> Void)
    /**
     ...
     */
    func updateTableReplicaAutoScaling(input: UpdateTableReplicaAutoScalingInput, completion: @escaping (SdkResult<UpdateTableReplicaAutoScalingOutput, UpdateTableReplicaAutoScalingError>) -> Void)
    /**
     ...
     */
    func updateTimeToLive(input: UpdateTimeToLiveInput, completion: @escaping (SdkResult<UpdateTimeToLiveOutput, UpdateTimeToLiveError>) -> Void)
}
