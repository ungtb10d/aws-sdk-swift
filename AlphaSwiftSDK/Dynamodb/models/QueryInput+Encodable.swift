...
extension QueryInput: Encodable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let exclusiveStartKey = exclusiveStartKey {
            var exclusiveStartKeyContainer = container.nestedContainer(keyedBy: Key.self, forKey: .exclusiveStartKey)
        ...
        if let keyConditionExpression = keyConditionExpression {
            try container.encode(keyConditionExpression, forKey: .keyConditionExpression)
        }
        if let keyConditions = keyConditions {
            var keyConditionsContainer = container.nestedContainer(keyedBy: Key.self, forKey: .keyConditions)
        ...
        if let queryFilter = queryFilter {
            var queryFilterContainer = container.nestedContainer(keyedBy: Key.self, forKey: .queryFilter)
        ...
        if let scanIndexForward = scanIndexForward {
            try container.encode(scanIndexForward, forKey: .scanIndexForward)
        }
        if let select = select {
            try container.encode(select.rawValue, forKey: .select)
        }
