...
public struct CreateGlobalTableInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<CreateGlobalTableOutput, CreateGlobalTableError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<CreateGlobalTableOutput, CreateGlobalTableError>
