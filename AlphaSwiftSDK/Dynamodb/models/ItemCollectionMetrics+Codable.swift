...
extension ItemCollectionMetrics: Codable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let itemCollectionKey = itemCollectionKey {
            var itemCollectionKeyContainer = container.nestedContainer(keyedBy: Key.self, forKey: .itemCollectionKey)
        ...
        if let sizeEstimateRangeGB = sizeEstimateRangeGB {
            var sizeEstimateRangeGBContainer = container.nestedUnkeyedContainer(forKey: .sizeEstimateRangeGB)
