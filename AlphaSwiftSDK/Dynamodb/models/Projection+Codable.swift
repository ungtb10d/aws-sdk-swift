...
extension Projection: Codable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let nonKeyAttributes = nonKeyAttributes {
            var nonKeyAttributesContainer = container.nestedUnkeyedContainer(forKey: .nonKeyAttributes)
        ...
        if let projectionType = projectionType {
            try container.encode(projectionType.rawValue, forKey: .projectionType)
        }
    }
