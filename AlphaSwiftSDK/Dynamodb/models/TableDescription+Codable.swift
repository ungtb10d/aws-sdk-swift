...
extension TableDescription: Codable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let archivalSummary = archivalSummary {
            try container.encode(archivalSummary, forKey: .archivalSummary)
        }
        ...
        if let billingModeSummary = billingModeSummary {
            try container.encode(billingModeSummary, forKey: .billingModeSummary)
        }
        ...
        if let globalTableVersion = globalTableVersion {
            try container.encode(globalTableVersion, forKey: .globalTableVersion)
        }
        if itemCount != 0 {
        ...
        if let latestStreamArn = latestStreamArn {
            try container.encode(latestStreamArn, forKey: .latestStreamArn)
        }
        if let latestStreamLabel = latestStreamLabel {
            try container.encode(latestStreamLabel, forKey: .latestStreamLabel)
        }
        ...
        if let restoreSummary = restoreSummary {
            try container.encode(restoreSummary, forKey: .restoreSummary)
        }
        if let sSEDescription = sSEDescription {
            try container.encode(sSEDescription, forKey: .sSEDescription)
        }
