...
extension ReplicaAutoScalingUpdate: Codable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let replicaGlobalSecondaryIndexUpdates = replicaGlobalSecondaryIndexUpdates {
            var replicaGlobalSecondaryIndexUpdatesContainer = container.nestedUnkeyedContainer(forKey: .replicaGlobalSecondaryIndexUpdates)
        ...
        if let replicaProvisionedReadCapacityAutoScalingUpdate = replicaProvisionedReadCapacityAutoScalingUpdate {
            try container.encode(replicaProvisionedReadCapacityAutoScalingUpdate, forKey: .replicaProvisionedReadCapacityAutoScalingUpdate)
        }
    }
