...
public protocol LambdaClientProtocol {
     ...
     */
    func addLayerVersionPermission(input: AddLayerVersionPermissionInput, completion: @escaping (SdkResult<AddLayerVersionPermissionOutput, AddLayerVersionPermissionError>) -> Void)
    /**
     ...
     */
    func addPermission(input: AddPermissionInput, completion: @escaping (SdkResult<AddPermissionOutput, AddPermissionError>) -> Void)
    /**
     <p>Creates an <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a> for a
           ...
           it receives.</p>
     */
    func createAlias(input: CreateAliasInput, completion: @escaping (SdkResult<CreateAliasOutput, CreateAliasError>) -> Void)
    /**
     ...
     */
    func createCodeSigningConfig(input: CreateCodeSigningConfigInput, completion: @escaping (SdkResult<CreateCodeSigningConfigOutput, CreateCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func createEventSourceMapping(input: CreateEventSourceMappingInput, completion: @escaping (SdkResult<CreateEventSourceMappingOutput, CreateEventSourceMappingError>) -> Void)
    /**
     ...
     */
    func createFunction(input: CreateFunctionInput, completion: @escaping (SdkResult<CreateFunctionOutput, CreateFunctionError>) -> Void)
    /// <p>Deletes a Lambda function <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a>.</p>
    func deleteAlias(input: DeleteAliasInput, completion: @escaping (SdkResult<DeleteAliasOutput, DeleteAliasError>) -> Void)
    /**
     <p>Deletes the code signing configuration. You can delete the code signing configuration only if no function is
           using it. </p>
     */
    func deleteCodeSigningConfig(input: DeleteCodeSigningConfigInput, completion: @escaping (SdkResult<DeleteCodeSigningConfigOutput, DeleteCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func deleteEventSourceMapping(input: DeleteEventSourceMappingInput, completion: @escaping (SdkResult<DeleteEventSourceMappingOutput, DeleteEventSourceMappingError>) -> Void)
    /**
     ...
     */
    func deleteFunction(input: DeleteFunctionInput, completion: @escaping (SdkResult<DeleteFunctionOutput, DeleteFunctionError>) -> Void)
    /// <p>Removes the code signing configuration from the function.</p>
    func deleteFunctionCodeSigningConfig(input: DeleteFunctionCodeSigningConfigInput, completion: @escaping (SdkResult<DeleteFunctionCodeSigningConfigOutput, DeleteFunctionCodeSigningConfigError>) -> Void)
    /// <p>Removes a concurrent execution limit from a function.</p>
    func deleteFunctionConcurrency(input: DeleteFunctionConcurrencyInput, completion: @escaping (SdkResult<DeleteFunctionConcurrencyOutput, DeleteFunctionConcurrencyError>) -> Void)
    /**
     <p>Deletes the configuration for asynchronous invocation for a function, version, or alias.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    func deleteFunctionEventInvokeConfig(input: DeleteFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<DeleteFunctionEventInvokeConfigOutput, DeleteFunctionEventInvokeConfigError>) -> Void)
    /**
     ...
     */
    func deleteLayerVersion(input: DeleteLayerVersionInput, completion: @escaping (SdkResult<DeleteLayerVersionOutput, DeleteLayerVersionError>) -> Void)
    /// <p>Deletes the provisioned concurrency configuration for a function.</p>
    func deleteProvisionedConcurrencyConfig(input: DeleteProvisionedConcurrencyConfigInput, completion: @escaping (SdkResult<DeleteProvisionedConcurrencyConfigOutput, DeleteProvisionedConcurrencyConfigError>) -> Void)
    ...
    func getAccountSettings(input: GetAccountSettingsInput, completion: @escaping (SdkResult<GetAccountSettingsOutput, GetAccountSettingsError>) -> Void)
    ...
    func getAlias(input: GetAliasInput, completion: @escaping (SdkResult<GetAliasOutput, GetAliasError>) -> Void)
    /// <p>Returns information about the specified code signing configuration.</p>
    func getCodeSigningConfig(input: GetCodeSigningConfigInput, completion: @escaping (SdkResult<GetCodeSigningConfigOutput, GetCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func getEventSourceMapping(input: GetEventSourceMappingInput, completion: @escaping (SdkResult<GetEventSourceMappingOutput, GetEventSourceMappingError>) -> Void)
    /**
     <p>Returns information about the function or function version, with a link to download the deployment package
           ...
           returned.</p>
     */
    func getFunction(input: GetFunctionInput, completion: @escaping (SdkResult<GetFunctionOutput, GetFunctionError>) -> Void)
    /// <p>Returns the code signing configuration for the specified function.</p>
    func getFunctionCodeSigningConfig(input: GetFunctionCodeSigningConfigInput, completion: @escaping (SdkResult<GetFunctionCodeSigningConfigOutput, GetFunctionCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func getFunctionConcurrency(input: GetFunctionConcurrencyInput, completion: @escaping (SdkResult<GetFunctionConcurrencyOutput, GetFunctionConcurrencyError>) -> Void)
    /**
     ...
     */
    func getFunctionConfiguration(input: GetFunctionConfigurationInput, completion: @escaping (SdkResult<GetFunctionConfigurationOutput, GetFunctionConfigurationError>) -> Void)
    /**
     <p>Retrieves the configuration for asynchronous invocation for a function, version, or alias.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    func getFunctionEventInvokeConfig(input: GetFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<GetFunctionEventInvokeConfigOutput, GetFunctionEventInvokeConfigError>) -> Void)
    /**
     ...
     */
    func getLayerVersion(input: GetLayerVersionInput, completion: @escaping (SdkResult<GetLayerVersionOutput, GetLayerVersionError>) -> Void)
    /**
     <p>Returns information about a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda
             layer</a>, with a link to download the layer archive
             that's valid for 10 minutes.</p>
     */
    func getLayerVersionByArn(input: GetLayerVersionByArnInput, completion: @escaping (SdkResult<GetLayerVersionByArnOutput, GetLayerVersionByArnError>) -> Void)
    /**
     ...
     */
    func getLayerVersionPolicy(input: GetLayerVersionPolicyInput, completion: @escaping (SdkResult<GetLayerVersionPolicyOutput, GetLayerVersionPolicyError>) -> Void)
    ...
    func getPolicy(input: GetPolicyInput, completion: @escaping (SdkResult<GetPolicyOutput, GetPolicyError>) -> Void)
    /// <p>Retrieves the provisioned concurrency configuration for a function's alias or version.</p>
    func getProvisionedConcurrencyConfig(input: GetProvisionedConcurrencyConfigInput, completion: @escaping (SdkResult<GetProvisionedConcurrencyConfigOutput, GetProvisionedConcurrencyConfigError>) -> Void)
    /**
     ...
     */
    func invoke(input: InvokeInput, completion: @escaping (SdkResult<InvokeOutput, InvokeError>) -> Void)
    /**
     <important>
    ...
    func invokeAsync(input: InvokeAsyncInput, streamSource: StreamSource, completion: @escaping (SdkResult<InvokeAsyncOutput, InvokeAsyncError>) -> Void)
    /**
     ...
     */
    func listAliases(input: ListAliasesInput, completion: @escaping (SdkResult<ListAliasesOutput, ListAliasesError>) -> Void)
    /**
     ...
     */
    func listCodeSigningConfigs(input: ListCodeSigningConfigsInput, completion: @escaping (SdkResult<ListCodeSigningConfigsOutput, ListCodeSigningConfigsError>) -> Void)
    /**
     ...
     */
    func listEventSourceMappings(input: ListEventSourceMappingsInput, completion: @escaping (SdkResult<ListEventSourceMappingsOutput, ListEventSourceMappingsError>) -> Void)
    /**
     <p>Retrieves a list of configurations for asynchronous invocation for a function.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    func listFunctionEventInvokeConfigs(input: ListFunctionEventInvokeConfigsInput, completion: @escaping (SdkResult<ListFunctionEventInvokeConfigsOutput, ListFunctionEventInvokeConfigsError>) -> Void)
    /**
     ...
     */
    func listFunctions(input: ListFunctionsInput, completion: @escaping (SdkResult<ListFunctionsOutput, ListFunctionsError>) -> Void)
    /**
     ...
     */
    func listFunctionsByCodeSigningConfig(input: ListFunctionsByCodeSigningConfigInput, completion: @escaping (SdkResult<ListFunctionsByCodeSigningConfigOutput, ListFunctionsByCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func listLayers(input: ListLayersInput, completion: @escaping (SdkResult<ListLayersOutput, ListLayersError>) -> Void)
    /**
     ...
     */
    func listLayerVersions(input: ListLayerVersionsInput, completion: @escaping (SdkResult<ListLayerVersionsOutput, ListLayerVersionsError>) -> Void)
    /// <p>Retrieves a list of provisioned concurrency configurations for a function.</p>
    func listProvisionedConcurrencyConfigs(input: ListProvisionedConcurrencyConfigsInput, completion: @escaping (SdkResult<ListProvisionedConcurrencyConfigsOutput, ListProvisionedConcurrencyConfigsError>) -> Void)
    /**
     ...
     */
    func listTags(input: ListTagsInput, completion: @escaping (SdkResult<ListTagsOutput, ListTagsError>) -> Void)
    /**
     ...
     */
    func listVersionsByFunction(input: ListVersionsByFunctionInput, completion: @escaping (SdkResult<ListVersionsByFunctionOutput, ListVersionsByFunctionError>) -> Void)
    /**
     ...
     */
    func publishLayerVersion(input: PublishLayerVersionInput, completion: @escaping (SdkResult<PublishLayerVersionOutput, PublishLayerVersionError>) -> Void)
    /**
     ...
     */
    func publishVersion(input: PublishVersionInput, completion: @escaping (SdkResult<PublishVersionOutput, PublishVersionError>) -> Void)
    /**
     ...
     */
    func putFunctionCodeSigningConfig(input: PutFunctionCodeSigningConfigInput, completion: @escaping (SdkResult<PutFunctionCodeSigningConfigOutput, PutFunctionCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func putFunctionConcurrency(input: PutFunctionConcurrencyInput, completion: @escaping (SdkResult<PutFunctionConcurrencyOutput, PutFunctionConcurrencyError>) -> Void)
    /**
     <p>Configures options for <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-async.html">asynchronous
           ...
           dead-letter queue.</p>
     */
    func putFunctionEventInvokeConfig(input: PutFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<PutFunctionEventInvokeConfigOutput, PutFunctionEventInvokeConfigError>) -> Void)
    /// <p>Adds a provisioned concurrency configuration to a function's alias or version.</p>
    func putProvisionedConcurrencyConfig(input: PutProvisionedConcurrencyConfigInput, completion: @escaping (SdkResult<PutProvisionedConcurrencyConfigOutput, PutProvisionedConcurrencyConfigError>) -> Void)
    /**
     ...
     */
    func removeLayerVersionPermission(input: RemoveLayerVersionPermissionInput, completion: @escaping (SdkResult<RemoveLayerVersionPermissionOutput, RemoveLayerVersionPermissionError>) -> Void)
    /**
     ...
     */
    func removePermission(input: RemovePermissionInput, completion: @escaping (SdkResult<RemovePermissionOutput, RemovePermissionError>) -> Void)
    ...
    func updateAlias(input: UpdateAliasInput, completion: @escaping (SdkResult<UpdateAliasOutput, UpdateAliasError>) -> Void)
    /**
     ...
     */
    func updateCodeSigningConfig(input: UpdateCodeSigningConfigInput, completion: @escaping (SdkResult<UpdateCodeSigningConfigOutput, UpdateCodeSigningConfigError>) -> Void)
    /**
     ...
     */
    func updateEventSourceMapping(input: UpdateEventSourceMappingInput, completion: @escaping (SdkResult<UpdateEventSourceMappingOutput, UpdateEventSourceMappingError>) -> Void)
    /**
     ...
     */
    func updateFunctionCode(input: UpdateFunctionCodeInput, completion: @escaping (SdkResult<UpdateFunctionCodeOutput, UpdateFunctionCodeError>) -> Void)
    /**
     ...
     */
    func updateFunctionConfiguration(input: UpdateFunctionConfigurationInput, completion: @escaping (SdkResult<UpdateFunctionConfigurationOutput, UpdateFunctionConfigurationError>) -> Void)
    /**
     <p>Updates the configuration for asynchronous invocation for a function, version, or alias.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    func updateFunctionEventInvokeConfig(input: UpdateFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<UpdateFunctionEventInvokeConfigOutput, UpdateFunctionEventInvokeConfigError>) -> Void)
}
