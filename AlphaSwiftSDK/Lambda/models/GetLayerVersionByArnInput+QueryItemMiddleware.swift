...
public struct GetLayerVersionByArnInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<GetLayerVersionByArnOutput, GetLayerVersionByArnError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    Self.Context == H.Context
    {
        ...
        if let arn = input.operationInput.arn {
            let queryItem = URLQueryItem(name: "Arn", value: String(arn))
    ...
    public typealias MOutput = OperationOutput<GetLayerVersionByArnOutput, GetLayerVersionByArnError>
