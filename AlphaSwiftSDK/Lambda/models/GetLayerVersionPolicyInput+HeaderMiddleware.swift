...
public struct GetLayerVersionPolicyInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<GetLayerVersionPolicyOutput, GetLayerVersionPolicyError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetLayerVersionPolicyOutput, GetLayerVersionPolicyError>
