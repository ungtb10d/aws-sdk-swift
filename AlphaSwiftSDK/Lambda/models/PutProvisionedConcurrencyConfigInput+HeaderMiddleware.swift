...
public struct PutProvisionedConcurrencyConfigInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<PutProvisionedConcurrencyConfigOutput, PutProvisionedConcurrencyConfigError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<PutProvisionedConcurrencyConfigOutput, PutProvisionedConcurrencyConfigError>
