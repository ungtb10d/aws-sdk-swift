...
public struct PutFunctionCodeSigningConfigInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<PutFunctionCodeSigningConfigOutput, PutFunctionCodeSigningConfigError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<PutFunctionCodeSigningConfigOutput, PutFunctionCodeSigningConfigError>
