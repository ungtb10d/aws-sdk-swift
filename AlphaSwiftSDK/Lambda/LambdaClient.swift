...
public class LambdaClient {
    ...
    public class LambdaClientConfiguration: Configuration, AWSClientConfiguration {
...
extension LambdaClient: LambdaClientProtocol {
     ...
     */
    public func addLayerVersionPermission(input: AddLayerVersionPermissionInput, completion: @escaping (SdkResult<AddLayerVersionPermissionOutput, AddLayerVersionPermissionError>) -> Void)
    {
        ...
        let path = "/2018-10-31/layers/\(layerName)/versions/\(versionNumber)/policy"
        ...
        var operation = OperationStack<AddLayerVersionPermissionInput, AddLayerVersionPermissionOutput, AddLayerVersionPermissionError>(id: "addLayerVersionPermission")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddLayerVersionPermissionInput, AddLayerVersionPermissionOutput, AddLayerVersionPermissionError>(contentType: "application/json"))
     ...
     */
    public func addPermission(input: AddPermissionInput, completion: @escaping (SdkResult<AddPermissionOutput, AddPermissionError>) -> Void)
    {
        ...
        let path = "/2015-03-31/functions/\(functionName)/policy"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .post)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AddPermissionInput, AddPermissionOutput, AddPermissionError>(id: "addPermission")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddPermissionInput, AddPermissionOutput, AddPermissionError>(contentType: "application/json"))
    ...
    /**
     <p>Creates an <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a> for a
           ...
           it receives.</p>
     */
    public func createAlias(input: CreateAliasInput, completion: @escaping (SdkResult<CreateAliasOutput, CreateAliasError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2015-03-31/functions/\(functionName)/aliases"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .post)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateAliasInput, CreateAliasOutput, CreateAliasError>(id: "createAlias")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateAliasInput, CreateAliasOutput, CreateAliasError>(contentType: "application/json"))
     ...
     */
    public func createCodeSigningConfig(input: CreateCodeSigningConfigInput, completion: @escaping (SdkResult<CreateCodeSigningConfigOutput, CreateCodeSigningConfigError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateCodeSigningConfigInput, CreateCodeSigningConfigOutput, CreateCodeSigningConfigError>(id: "createCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCodeSigningConfigInput, CreateCodeSigningConfigOutput, CreateCodeSigningConfigError>(contentType: "application/json"))
     ...
     */
    public func createEventSourceMapping(input: CreateEventSourceMappingInput, completion: @escaping (SdkResult<CreateEventSourceMappingOutput, CreateEventSourceMappingError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateEventSourceMappingInput, CreateEventSourceMappingOutput, CreateEventSourceMappingError>(id: "createEventSourceMapping")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateEventSourceMappingInput, CreateEventSourceMappingOutput, CreateEventSourceMappingError>(contentType: "application/json"))
     ...
     */
    public func createFunction(input: CreateFunctionInput, completion: @escaping (SdkResult<CreateFunctionOutput, CreateFunctionError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateFunctionInput, CreateFunctionOutput, CreateFunctionError>(id: "createFunction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateFunctionInput, CreateFunctionOutput, CreateFunctionError>(contentType: "application/json"))
    ...
    public func deleteAlias(input: DeleteAliasInput, completion: @escaping (SdkResult<DeleteAliasOutput, DeleteAliasError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let path = "/2015-03-31/functions/\(functionName)/aliases/\(name)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAliasInput, DeleteAliasOutput, DeleteAliasError>(id: "deleteAlias")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAliasInput, DeleteAliasOutput, DeleteAliasError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    /**
     <p>Deletes the code signing configuration. You can delete the code signing configuration only if no function is
           using it. </p>
     */
    public func deleteCodeSigningConfig(input: DeleteCodeSigningConfigInput, completion: @escaping (SdkResult<DeleteCodeSigningConfigOutput, DeleteCodeSigningConfigError>) -> Void)
    {
        ...
        let path = "/2020-04-22/code-signing-configs/\(codeSigningConfigArn)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCodeSigningConfigInput, DeleteCodeSigningConfigOutput, DeleteCodeSigningConfigError>(id: "deleteCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteCodeSigningConfigInput, DeleteCodeSigningConfigOutput, DeleteCodeSigningConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func deleteEventSourceMapping(input: DeleteEventSourceMappingInput, completion: @escaping (SdkResult<DeleteEventSourceMappingOutput, DeleteEventSourceMappingError>) -> Void)
    {
        ...
        let path = "/2015-03-31/event-source-mappings/\(uUID)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteEventSourceMappingInput, DeleteEventSourceMappingOutput, DeleteEventSourceMappingError>(id: "deleteEventSourceMapping")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteEventSourceMappingInput, DeleteEventSourceMappingOutput, DeleteEventSourceMappingError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func deleteFunction(input: DeleteFunctionInput, completion: @escaping (SdkResult<DeleteFunctionOutput, DeleteFunctionError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2015-03-31/functions/\(functionName)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteFunctionInput, DeleteFunctionOutput, DeleteFunctionError>(id: "deleteFunction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteFunctionInput, DeleteFunctionOutput, DeleteFunctionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func deleteFunctionCodeSigningConfig(input: DeleteFunctionCodeSigningConfigInput, completion: @escaping (SdkResult<DeleteFunctionCodeSigningConfigOutput, DeleteFunctionCodeSigningConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2020-06-30/functions/\(functionName)/code-signing-config"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteFunctionCodeSigningConfigInput, DeleteFunctionCodeSigningConfigOutput, DeleteFunctionCodeSigningConfigError>(id: "deleteFunctionCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteFunctionCodeSigningConfigInput, DeleteFunctionCodeSigningConfigOutput, DeleteFunctionCodeSigningConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func deleteFunctionConcurrency(input: DeleteFunctionConcurrencyInput, completion: @escaping (SdkResult<DeleteFunctionConcurrencyOutput, DeleteFunctionConcurrencyError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2017-10-31/functions/\(functionName)/concurrency"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteFunctionConcurrencyInput, DeleteFunctionConcurrencyOutput, DeleteFunctionConcurrencyError>(id: "deleteFunctionConcurrency")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteFunctionConcurrencyInput, DeleteFunctionConcurrencyOutput, DeleteFunctionConcurrencyError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func deleteFunctionEventInvokeConfig(input: DeleteFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<DeleteFunctionEventInvokeConfigOutput, DeleteFunctionEventInvokeConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2019-09-25/functions/\(functionName)/event-invoke-config"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteFunctionEventInvokeConfigInput, DeleteFunctionEventInvokeConfigOutput, DeleteFunctionEventInvokeConfigError>(id: "deleteFunctionEventInvokeConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteFunctionEventInvokeConfigInput, DeleteFunctionEventInvokeConfigOutput, DeleteFunctionEventInvokeConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func deleteLayerVersion(input: DeleteLayerVersionInput, completion: @escaping (SdkResult<DeleteLayerVersionOutput, DeleteLayerVersionError>) -> Void)
    {
        guard let layerName = input.layerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component layerName unexpectedly nil"))))
            return
        ...
        let versionNumber = input.versionNumber
        let path = "/2018-10-31/layers/\(layerName)/versions/\(versionNumber)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteLayerVersionInput, DeleteLayerVersionOutput, DeleteLayerVersionError>(id: "deleteLayerVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteLayerVersionInput, DeleteLayerVersionOutput, DeleteLayerVersionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func deleteProvisionedConcurrencyConfig(input: DeleteProvisionedConcurrencyConfigInput, completion: @escaping (SdkResult<DeleteProvisionedConcurrencyConfigOutput, DeleteProvisionedConcurrencyConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2019-09-30/functions/\(functionName)/provisioned-concurrency"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteProvisionedConcurrencyConfigInput, DeleteProvisionedConcurrencyConfigOutput, DeleteProvisionedConcurrencyConfigError>(id: "deleteProvisionedConcurrencyConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteProvisionedConcurrencyConfigInput, DeleteProvisionedConcurrencyConfigOutput, DeleteProvisionedConcurrencyConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func getAccountSettings(input: GetAccountSettingsInput, completion: @escaping (SdkResult<GetAccountSettingsOutput, GetAccountSettingsError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccountSettingsInput, GetAccountSettingsOutput, GetAccountSettingsError>(id: "getAccountSettings")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccountSettingsInput, GetAccountSettingsOutput, GetAccountSettingsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func getAlias(input: GetAliasInput, completion: @escaping (SdkResult<GetAliasOutput, GetAliasError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAliasInput, GetAliasOutput, GetAliasError>(id: "getAlias")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAliasInput, GetAliasOutput, GetAliasError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func getCodeSigningConfig(input: GetCodeSigningConfigInput, completion: @escaping (SdkResult<GetCodeSigningConfigOutput, GetCodeSigningConfigError>) -> Void)
    {
        guard let codeSigningConfigArn = input.codeSigningConfigArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component codeSigningConfigArn unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCodeSigningConfigInput, GetCodeSigningConfigOutput, GetCodeSigningConfigError>(id: "getCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCodeSigningConfigInput, GetCodeSigningConfigOutput, GetCodeSigningConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func getEventSourceMapping(input: GetEventSourceMappingInput, completion: @escaping (SdkResult<GetEventSourceMappingOutput, GetEventSourceMappingError>) -> Void)
    {
        guard let uUID = input.uUID else {
            completion(.failure(.client(ClientError.serializationFailed("uri component uUID unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetEventSourceMappingInput, GetEventSourceMappingOutput, GetEventSourceMappingError>(id: "getEventSourceMapping")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetEventSourceMappingInput, GetEventSourceMappingOutput, GetEventSourceMappingError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    /**
     <p>Returns information about the function or function version, with a link to download the deployment package
           ...
           returned.</p>
     */
    public func getFunction(input: GetFunctionInput, completion: @escaping (SdkResult<GetFunctionOutput, GetFunctionError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFunctionInput, GetFunctionOutput, GetFunctionError>(id: "getFunction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFunctionInput, GetFunctionOutput, GetFunctionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func getFunctionCodeSigningConfig(input: GetFunctionCodeSigningConfigInput, completion: @escaping (SdkResult<GetFunctionCodeSigningConfigOutput, GetFunctionCodeSigningConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFunctionCodeSigningConfigInput, GetFunctionCodeSigningConfigOutput, GetFunctionCodeSigningConfigError>(id: "getFunctionCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFunctionCodeSigningConfigInput, GetFunctionCodeSigningConfigOutput, GetFunctionCodeSigningConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func getFunctionConcurrency(input: GetFunctionConcurrencyInput, completion: @escaping (SdkResult<GetFunctionConcurrencyOutput, GetFunctionConcurrencyError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2019-09-30/functions/\(functionName)/concurrency"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFunctionConcurrencyInput, GetFunctionConcurrencyOutput, GetFunctionConcurrencyError>(id: "getFunctionConcurrency")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFunctionConcurrencyInput, GetFunctionConcurrencyOutput, GetFunctionConcurrencyError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func getFunctionConfiguration(input: GetFunctionConfigurationInput, completion: @escaping (SdkResult<GetFunctionConfigurationOutput, GetFunctionConfigurationError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2015-03-31/functions/\(functionName)/configuration"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFunctionConfigurationInput, GetFunctionConfigurationOutput, GetFunctionConfigurationError>(id: "getFunctionConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFunctionConfigurationInput, GetFunctionConfigurationOutput, GetFunctionConfigurationError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    /**
     <p>Retrieves the configuration for asynchronous invocation for a function, version, or alias.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    public func getFunctionEventInvokeConfig(input: GetFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<GetFunctionEventInvokeConfigOutput, GetFunctionEventInvokeConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFunctionEventInvokeConfigInput, GetFunctionEventInvokeConfigOutput, GetFunctionEventInvokeConfigError>(id: "getFunctionEventInvokeConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFunctionEventInvokeConfigInput, GetFunctionEventInvokeConfigOutput, GetFunctionEventInvokeConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func getLayerVersion(input: GetLayerVersionInput, completion: @escaping (SdkResult<GetLayerVersionOutput, GetLayerVersionError>) -> Void)
    {
        guard let layerName = input.layerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component layerName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetLayerVersionInput, GetLayerVersionOutput, GetLayerVersionError>(id: "getLayerVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetLayerVersionInput, GetLayerVersionOutput, GetLayerVersionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    /**
     <p>Returns information about a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda
             ...
             that's valid for 10 minutes.</p>
     */
    public func getLayerVersionByArn(input: GetLayerVersionByArnInput, completion: @escaping (SdkResult<GetLayerVersionByArnOutput, GetLayerVersionByArnError>) -> Void)
    {
        let path = "/2018-10-31/layers"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetLayerVersionByArnInput, GetLayerVersionByArnOutput, GetLayerVersionByArnError>(id: "getLayerVersionByArn")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetLayerVersionByArnInput, GetLayerVersionByArnOutput, GetLayerVersionByArnError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func getLayerVersionPolicy(input: GetLayerVersionPolicyInput, completion: @escaping (SdkResult<GetLayerVersionPolicyOutput, GetLayerVersionPolicyError>) -> Void)
    {
        guard let layerName = input.layerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component layerName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetLayerVersionPolicyInput, GetLayerVersionPolicyOutput, GetLayerVersionPolicyError>(id: "getLayerVersionPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetLayerVersionPolicyInput, GetLayerVersionPolicyOutput, GetLayerVersionPolicyError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func getPolicy(input: GetPolicyInput, completion: @escaping (SdkResult<GetPolicyOutput, GetPolicyError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetPolicyInput, GetPolicyOutput, GetPolicyError>(id: "getPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetPolicyInput, GetPolicyOutput, GetPolicyError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func getProvisionedConcurrencyConfig(input: GetProvisionedConcurrencyConfigInput, completion: @escaping (SdkResult<GetProvisionedConcurrencyConfigOutput, GetProvisionedConcurrencyConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetProvisionedConcurrencyConfigInput, GetProvisionedConcurrencyConfigOutput, GetProvisionedConcurrencyConfigError>(id: "getProvisionedConcurrencyConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetProvisionedConcurrencyConfigInput, GetProvisionedConcurrencyConfigOutput, GetProvisionedConcurrencyConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func invoke(input: InvokeInput, completion: @escaping (SdkResult<InvokeOutput, InvokeError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2015-03-31/functions/\(functionName)/invocations"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .post)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<InvokeInput, InvokeOutput, InvokeError>(id: "invoke")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<InvokeInput, InvokeOutput, InvokeError>(contentType: "application/json"))
    ...
    public func invokeAsync(input: InvokeAsyncInput, streamSource: StreamSource, completion: @escaping (SdkResult<InvokeAsyncOutput, InvokeAsyncError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2014-11-13/functions/\(functionName)/invoke-async"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .post)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<InvokeAsyncInput, InvokeAsyncOutput, InvokeAsyncError>(id: "invokeAsync")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<InvokeAsyncInput, InvokeAsyncOutput, InvokeAsyncError>(contentType: "application/json"))
     ...
     */
    public func listAliases(input: ListAliasesInput, completion: @escaping (SdkResult<ListAliasesOutput, ListAliasesError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAliasesInput, ListAliasesOutput, ListAliasesError>(id: "listAliases")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAliasesInput, ListAliasesOutput, ListAliasesError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listCodeSigningConfigs(input: ListCodeSigningConfigsInput, completion: @escaping (SdkResult<ListCodeSigningConfigsOutput, ListCodeSigningConfigsError>) -> Void)
    {
        let path = "/2020-04-22/code-signing-configs"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCodeSigningConfigsInput, ListCodeSigningConfigsOutput, ListCodeSigningConfigsError>(id: "listCodeSigningConfigs")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListCodeSigningConfigsInput, ListCodeSigningConfigsOutput, ListCodeSigningConfigsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listEventSourceMappings(input: ListEventSourceMappingsInput, completion: @escaping (SdkResult<ListEventSourceMappingsOutput, ListEventSourceMappingsError>) -> Void)
    {
        let path = "/2015-03-31/event-source-mappings"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListEventSourceMappingsInput, ListEventSourceMappingsOutput, ListEventSourceMappingsError>(id: "listEventSourceMappings")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListEventSourceMappingsInput, ListEventSourceMappingsOutput, ListEventSourceMappingsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    /**
     <p>Retrieves a list of configurations for asynchronous invocation for a function.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    public func listFunctionEventInvokeConfigs(input: ListFunctionEventInvokeConfigsInput, completion: @escaping (SdkResult<ListFunctionEventInvokeConfigsOutput, ListFunctionEventInvokeConfigsError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2019-09-25/functions/\(functionName)/event-invoke-config/list"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListFunctionEventInvokeConfigsInput, ListFunctionEventInvokeConfigsOutput, ListFunctionEventInvokeConfigsError>(id: "listFunctionEventInvokeConfigs")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListFunctionEventInvokeConfigsInput, ListFunctionEventInvokeConfigsOutput, ListFunctionEventInvokeConfigsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listFunctions(input: ListFunctionsInput, completion: @escaping (SdkResult<ListFunctionsOutput, ListFunctionsError>) -> Void)
    {
        let path = "/2015-03-31/functions"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListFunctionsInput, ListFunctionsOutput, ListFunctionsError>(id: "listFunctions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListFunctionsInput, ListFunctionsOutput, ListFunctionsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listFunctionsByCodeSigningConfig(input: ListFunctionsByCodeSigningConfigInput, completion: @escaping (SdkResult<ListFunctionsByCodeSigningConfigOutput, ListFunctionsByCodeSigningConfigError>) -> Void)
    {
        guard let codeSigningConfigArn = input.codeSigningConfigArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component codeSigningConfigArn unexpectedly nil"))))
            return
        }
        let path = "/2020-04-22/code-signing-configs/\(codeSigningConfigArn)/functions"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListFunctionsByCodeSigningConfigInput, ListFunctionsByCodeSigningConfigOutput, ListFunctionsByCodeSigningConfigError>(id: "listFunctionsByCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListFunctionsByCodeSigningConfigInput, ListFunctionsByCodeSigningConfigOutput, ListFunctionsByCodeSigningConfigError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listLayerVersions(input: ListLayerVersionsInput, completion: @escaping (SdkResult<ListLayerVersionsOutput, ListLayerVersionsError>) -> Void)
    {
        guard let layerName = input.layerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component layerName unexpectedly nil"))))
            return
        }
        let path = "/2018-10-31/layers/\(layerName)/versions"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListLayerVersionsInput, ListLayerVersionsOutput, ListLayerVersionsError>(id: "listLayerVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListLayerVersionsInput, ListLayerVersionsOutput, ListLayerVersionsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listLayers(input: ListLayersInput, completion: @escaping (SdkResult<ListLayersOutput, ListLayersError>) -> Void)
    {
        let path = "/2018-10-31/layers"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListLayersInput, ListLayersOutput, ListLayersError>(id: "listLayers")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListLayersInput, ListLayersOutput, ListLayersError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func listProvisionedConcurrencyConfigs(input: ListProvisionedConcurrencyConfigsInput, completion: @escaping (SdkResult<ListProvisionedConcurrencyConfigsOutput, ListProvisionedConcurrencyConfigsError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListProvisionedConcurrencyConfigsInput, ListProvisionedConcurrencyConfigsOutput, ListProvisionedConcurrencyConfigsError>(id: "listProvisionedConcurrencyConfigs")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListProvisionedConcurrencyConfigsInput, ListProvisionedConcurrencyConfigsOutput, ListProvisionedConcurrencyConfigsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listTags(input: ListTagsInput, completion: @escaping (SdkResult<ListTagsOutput, ListTagsError>) -> Void)
    {
        ...
        let path = "/2017-03-31/tags/\(resource)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTagsInput, ListTagsOutput, ListTagsError>(id: "listTags")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTagsInput, ListTagsOutput, ListTagsError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func listVersionsByFunction(input: ListVersionsByFunctionInput, completion: @escaping (SdkResult<ListVersionsByFunctionOutput, ListVersionsByFunctionError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2015-03-31/functions/\(functionName)/versions"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListVersionsByFunctionInput, ListVersionsByFunctionOutput, ListVersionsByFunctionError>(id: "listVersionsByFunction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListVersionsByFunctionInput, ListVersionsByFunctionOutput, ListVersionsByFunctionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func publishLayerVersion(input: PublishLayerVersionInput, completion: @escaping (SdkResult<PublishLayerVersionOutput, PublishLayerVersionError>) -> Void)
    {
        guard let layerName = input.layerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component layerName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PublishLayerVersionInput, PublishLayerVersionOutput, PublishLayerVersionError>(id: "publishLayerVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PublishLayerVersionInput, PublishLayerVersionOutput, PublishLayerVersionError>(contentType: "application/json"))
     ...
     */
    public func publishVersion(input: PublishVersionInput, completion: @escaping (SdkResult<PublishVersionOutput, PublishVersionError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PublishVersionInput, PublishVersionOutput, PublishVersionError>(id: "publishVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PublishVersionInput, PublishVersionOutput, PublishVersionError>(contentType: "application/json"))
     ...
     */
    public func putFunctionCodeSigningConfig(input: PutFunctionCodeSigningConfigInput, completion: @escaping (SdkResult<PutFunctionCodeSigningConfigOutput, PutFunctionCodeSigningConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutFunctionCodeSigningConfigInput, PutFunctionCodeSigningConfigOutput, PutFunctionCodeSigningConfigError>(id: "putFunctionCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutFunctionCodeSigningConfigInput, PutFunctionCodeSigningConfigOutput, PutFunctionCodeSigningConfigError>(contentType: "application/json"))
     ...
     */
    public func putFunctionConcurrency(input: PutFunctionConcurrencyInput, completion: @escaping (SdkResult<PutFunctionConcurrencyOutput, PutFunctionConcurrencyError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutFunctionConcurrencyInput, PutFunctionConcurrencyOutput, PutFunctionConcurrencyError>(id: "putFunctionConcurrency")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutFunctionConcurrencyInput, PutFunctionConcurrencyOutput, PutFunctionConcurrencyError>(contentType: "application/json"))
    ...
    /**
     <p>Configures options for <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-async.html">asynchronous
           ...
           dead-letter queue.</p>
     */
    public func putFunctionEventInvokeConfig(input: PutFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<PutFunctionEventInvokeConfigOutput, PutFunctionEventInvokeConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutFunctionEventInvokeConfigInput, PutFunctionEventInvokeConfigOutput, PutFunctionEventInvokeConfigError>(id: "putFunctionEventInvokeConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutFunctionEventInvokeConfigInput, PutFunctionEventInvokeConfigOutput, PutFunctionEventInvokeConfigError>(contentType: "application/json"))
    ...
    public func putProvisionedConcurrencyConfig(input: PutProvisionedConcurrencyConfigInput, completion: @escaping (SdkResult<PutProvisionedConcurrencyConfigOutput, PutProvisionedConcurrencyConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutProvisionedConcurrencyConfigInput, PutProvisionedConcurrencyConfigOutput, PutProvisionedConcurrencyConfigError>(id: "putProvisionedConcurrencyConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutProvisionedConcurrencyConfigInput, PutProvisionedConcurrencyConfigOutput, PutProvisionedConcurrencyConfigError>(contentType: "application/json"))
     ...
     */
    public func removeLayerVersionPermission(input: RemoveLayerVersionPermissionInput, completion: @escaping (SdkResult<RemoveLayerVersionPermissionOutput, RemoveLayerVersionPermissionError>) -> Void)
    {
        guard let layerName = input.layerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component layerName unexpectedly nil"))))
            return
        ...
        let path = "/2018-10-31/layers/\(layerName)/versions/\(versionNumber)/policy/\(statementId)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RemoveLayerVersionPermissionInput, RemoveLayerVersionPermissionOutput, RemoveLayerVersionPermissionError>(id: "removeLayerVersionPermission")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RemoveLayerVersionPermissionInput, RemoveLayerVersionPermissionOutput, RemoveLayerVersionPermissionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
     ...
     */
    public func removePermission(input: RemovePermissionInput, completion: @escaping (SdkResult<RemovePermissionOutput, RemovePermissionError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let path = "/2015-03-31/functions/\(functionName)/policy/\(statementId)"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .delete)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RemovePermissionInput, RemovePermissionOutput, RemovePermissionError>(id: "removePermission")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RemovePermissionInput, RemovePermissionOutput, RemovePermissionError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func tagResource(input: TagResourceInput, completion: @escaping (SdkResult<TagResourceOutput, TagResourceError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<TagResourceInput, TagResourceOutput, TagResourceError>(contentType: "application/json"))
    ...
    public func untagResource(input: UntagResourceInput, completion: @escaping (SdkResult<UntagResourceOutput, UntagResourceError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UntagResourceInput, UntagResourceOutput, UntagResourceError>(contentType: "application/json"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(unsignedBody: false))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
    ...
    public func updateAlias(input: UpdateAliasInput, completion: @escaping (SdkResult<UpdateAliasOutput, UpdateAliasError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateAliasInput, UpdateAliasOutput, UpdateAliasError>(id: "updateAlias")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateAliasInput, UpdateAliasOutput, UpdateAliasError>(contentType: "application/json"))
     ...
     */
    public func updateCodeSigningConfig(input: UpdateCodeSigningConfigInput, completion: @escaping (SdkResult<UpdateCodeSigningConfigOutput, UpdateCodeSigningConfigError>) -> Void)
    {
        guard let codeSigningConfigArn = input.codeSigningConfigArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component codeSigningConfigArn unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateCodeSigningConfigInput, UpdateCodeSigningConfigOutput, UpdateCodeSigningConfigError>(id: "updateCodeSigningConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateCodeSigningConfigInput, UpdateCodeSigningConfigOutput, UpdateCodeSigningConfigError>(contentType: "application/json"))
     ...
     */
    public func updateEventSourceMapping(input: UpdateEventSourceMappingInput, completion: @escaping (SdkResult<UpdateEventSourceMappingOutput, UpdateEventSourceMappingError>) -> Void)
    {
        guard let uUID = input.uUID else {
            completion(.failure(.client(ClientError.serializationFailed("uri component uUID unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateEventSourceMappingInput, UpdateEventSourceMappingOutput, UpdateEventSourceMappingError>(id: "updateEventSourceMapping")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateEventSourceMappingInput, UpdateEventSourceMappingOutput, UpdateEventSourceMappingError>(contentType: "application/json"))
     ...
     */
    public func updateFunctionCode(input: UpdateFunctionCodeInput, completion: @escaping (SdkResult<UpdateFunctionCodeOutput, UpdateFunctionCodeError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        }
        let path = "/2015-03-31/functions/\(functionName)/code"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .put)
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateFunctionCodeInput, UpdateFunctionCodeOutput, UpdateFunctionCodeError>(id: "updateFunctionCode")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateFunctionCodeInput, UpdateFunctionCodeOutput, UpdateFunctionCodeError>(contentType: "application/json"))
     ...
     */
    public func updateFunctionConfiguration(input: UpdateFunctionConfigurationInput, completion: @escaping (SdkResult<UpdateFunctionConfigurationOutput, UpdateFunctionConfigurationError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateFunctionConfigurationInput, UpdateFunctionConfigurationOutput, UpdateFunctionConfigurationError>(id: "updateFunctionConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateFunctionConfigurationInput, UpdateFunctionConfigurationOutput, UpdateFunctionConfigurationError>(contentType: "application/json"))
    ...
    /**
     <p>Updates the configuration for asynchronous invocation for a function, version, or alias.</p>
              <p>To configure options for asynchronous invocation, use <a>PutFunctionEventInvokeConfig</a>.</p>
     */
    public func updateFunctionEventInvokeConfig(input: UpdateFunctionEventInvokeConfigInput, completion: @escaping (SdkResult<UpdateFunctionEventInvokeConfigOutput, UpdateFunctionEventInvokeConfigError>) -> Void)
    {
        guard let functionName = input.functionName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component functionName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lambda")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateFunctionEventInvokeConfigInput, UpdateFunctionEventInvokeConfigOutput, UpdateFunctionEventInvokeConfigError>(id: "updateFunctionEventInvokeConfig")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateFunctionEventInvokeConfigInput, UpdateFunctionEventInvokeConfigOutput, UpdateFunctionEventInvokeConfigError>(contentType: "application/json"))
