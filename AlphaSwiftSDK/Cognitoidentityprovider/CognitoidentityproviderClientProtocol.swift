...
public protocol CognitoidentityproviderClientProtocol {
    ...
    func addCustomAttributes(input: AddCustomAttributesInput, completion: @escaping (SdkResult<AddCustomAttributesOutput, AddCustomAttributesError>) -> Void)
    /**
     <p>Adds the specified user to the specified group.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminAddUserToGroup(input: AdminAddUserToGroupInput, completion: @escaping (SdkResult<AdminAddUserToGroupOutput, AdminAddUserToGroupError>) -> Void)
    /**
     <p>Confirms user registration as an admin without using a confirmation code. Works on any
                 user.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminConfirmSignUp(input: AdminConfirmSignUpInput, completion: @escaping (SdkResult<AdminConfirmSignUpOutput, AdminConfirmSignUpError>) -> Void)
    /**
     ...
     */
    func adminCreateUser(input: AdminCreateUserInput, completion: @escaping (SdkResult<AdminCreateUserOutput, AdminCreateUserError>) -> Void)
    /**
     <p>Deletes a user as an administrator. Works on any user.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminDeleteUser(input: AdminDeleteUserInput, completion: @escaping (SdkResult<AdminDeleteUserOutput, AdminDeleteUserError>) -> Void)
    /**
     <p>Deletes the user attributes in a user pool as an administrator. Works on any
                 user.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminDeleteUserAttributes(input: AdminDeleteUserAttributesInput, completion: @escaping (SdkResult<AdminDeleteUserAttributesOutput, AdminDeleteUserAttributesError>) -> Void)
    /**
     <p>Disables the user from signing in with the specified external (SAML or social)
             ...
             <p>For de-linking a SAML identity, there are two scenarios. If the linked identity has
                 ...
                 assertion.</p>
     */
    func adminDisableProviderForUser(input: AdminDisableProviderForUserInput, completion: @escaping (SdkResult<AdminDisableProviderForUserOutput, AdminDisableProviderForUserError>) -> Void)
    /**
     <p>Disables the specified user.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminDisableUser(input: AdminDisableUserInput, completion: @escaping (SdkResult<AdminDisableUserOutput, AdminDisableUserError>) -> Void)
    /**
     <p>Enables the specified user as an administrator. Works on any user.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminEnableUser(input: AdminEnableUserInput, completion: @escaping (SdkResult<AdminEnableUserOutput, AdminEnableUserError>) -> Void)
    /**
     <p>Forgets the device, as an administrator.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminForgetDevice(input: AdminForgetDeviceInput, completion: @escaping (SdkResult<AdminForgetDeviceOutput, AdminForgetDeviceError>) -> Void)
    /**
     <p>Gets the device, as an administrator.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminGetDevice(input: AdminGetDeviceInput, completion: @escaping (SdkResult<AdminGetDeviceOutput, AdminGetDeviceError>) -> Void)
    /**
     <p>Gets the specified user by user name in a user pool as an administrator. Works on any
                 user.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminGetUser(input: AdminGetUserInput, completion: @escaping (SdkResult<AdminGetUserOutput, AdminGetUserError>) -> Void)
    /**
     <p>Initiates the authentication flow, as an administrator.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminInitiateAuth(input: AdminInitiateAuthInput, completion: @escaping (SdkResult<AdminInitiateAuthOutput, AdminInitiateAuthError>) -> Void)
    /**
     <p>Links an existing user account in a user pool (<code>DestinationUser</code>) to an
             ...
             <p>This action is enabled only for admin access and requires developer
                 credentials.</p>
     */
    func adminLinkProviderForUser(input: AdminLinkProviderForUserInput, completion: @escaping (SdkResult<AdminLinkProviderForUserOutput, AdminLinkProviderForUserError>) -> Void)
    /**
     <p>Lists devices, as an administrator.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminListDevices(input: AdminListDevicesInput, completion: @escaping (SdkResult<AdminListDevicesOutput, AdminListDevicesError>) -> Void)
    /**
     <p>Lists the groups that the user belongs to.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminListGroupsForUser(input: AdminListGroupsForUserInput, completion: @escaping (SdkResult<AdminListGroupsForUserOutput, AdminListGroupsForUserError>) -> Void)
    /**
     <p>Lists a history of user activity and any risks detected as part of Amazon Cognito
                 advanced security.</p>
     */
    func adminListUserAuthEvents(input: AdminListUserAuthEventsInput, completion: @escaping (SdkResult<AdminListUserAuthEventsOutput, AdminListUserAuthEventsError>) -> Void)
    /**
     <p>Removes the specified user from the specified group.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminRemoveUserFromGroup(input: AdminRemoveUserFromGroupInput, completion: @escaping (SdkResult<AdminRemoveUserFromGroupOutput, AdminRemoveUserFromGroupError>) -> Void)
    /**
     <p>Resets the specified user's password in a user pool as an administrator. Works on any
             ...
             <p>Calling this action requires developer credentials.</p>
     */
    func adminResetUserPassword(input: AdminResetUserPasswordInput, completion: @escaping (SdkResult<AdminResetUserPasswordOutput, AdminResetUserPasswordError>) -> Void)
    /**
     <p>Responds to an authentication challenge, as an administrator.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminRespondToAuthChallenge(input: AdminRespondToAuthChallengeInput, completion: @escaping (SdkResult<AdminRespondToAuthChallengeOutput, AdminRespondToAuthChallengeError>) -> Void)
    /**
     ...
     */
    func adminSetUserMFAPreference(input: AdminSetUserMFAPreferenceInput, completion: @escaping (SdkResult<AdminSetUserMFAPreferenceOutput, AdminSetUserMFAPreferenceError>) -> Void)
    /**
     ...
     */
    func adminSetUserPassword(input: AdminSetUserPasswordInput, completion: @escaping (SdkResult<AdminSetUserPasswordOutput, AdminSetUserPasswordError>) -> Void)
    /**
     <p>
     ...
     */
    func adminSetUserSettings(input: AdminSetUserSettingsInput, completion: @escaping (SdkResult<AdminSetUserSettingsOutput, AdminSetUserSettingsError>) -> Void)
    /**
     ...
     */
    func adminUpdateAuthEventFeedback(input: AdminUpdateAuthEventFeedbackInput, completion: @escaping (SdkResult<AdminUpdateAuthEventFeedbackOutput, AdminUpdateAuthEventFeedbackError>) -> Void)
    /**
     <p>Updates the device status as an administrator.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func adminUpdateDeviceStatus(input: AdminUpdateDeviceStatusInput, completion: @escaping (SdkResult<AdminUpdateDeviceStatusOutput, AdminUpdateDeviceStatusError>) -> Void)
    /**
     <p>Updates the specified user's attributes, including developer attributes, as an
             ...
             <p>Calling this action requires developer credentials.</p>
     */
    func adminUpdateUserAttributes(input: AdminUpdateUserAttributesInput, completion: @escaping (SdkResult<AdminUpdateUserAttributesOutput, AdminUpdateUserAttributesError>) -> Void)
    /**
     <p>Signs out users from all devices, as an administrator. It also invalidates all refresh
             ...
             <p>Calling this action requires developer credentials.</p>
     */
    func adminUserGlobalSignOut(input: AdminUserGlobalSignOutInput, completion: @escaping (SdkResult<AdminUserGlobalSignOutOutput, AdminUserGlobalSignOutError>) -> Void)
    /**
     ...
     */
    func associateSoftwareToken(input: AssociateSoftwareTokenInput, completion: @escaping (SdkResult<AssociateSoftwareTokenOutput, AssociateSoftwareTokenError>) -> Void)
    /// <p>Changes the password for a specified user in a user pool.</p>
    func changePassword(input: ChangePasswordInput, completion: @escaping (SdkResult<ChangePasswordOutput, ChangePasswordError>) -> Void)
    /**
     <p>Confirms tracking of the device. This API call is the call that begins device
                 tracking.</p>
     */
    func confirmDevice(input: ConfirmDeviceInput, completion: @escaping (SdkResult<ConfirmDeviceOutput, ConfirmDeviceError>) -> Void)
    /// <p>Allows a user to enter a confirmation code to reset a forgotten password.</p>
    func confirmForgotPassword(input: ConfirmForgotPasswordInput, completion: @escaping (SdkResult<ConfirmForgotPasswordOutput, ConfirmForgotPasswordError>) -> Void)
    /**
     <p>Confirms registration of a user and handles the existing alias from a previous
                 user.</p>
     */
    func confirmSignUp(input: ConfirmSignUpInput, completion: @escaping (SdkResult<ConfirmSignUpOutput, ConfirmSignUpError>) -> Void)
    /**
     <p>Creates a new group in the specified user pool.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func createGroup(input: CreateGroupInput, completion: @escaping (SdkResult<CreateGroupOutput, CreateGroupError>) -> Void)
    /// <p>Creates an identity provider for a user pool.</p>
    func createIdentityProvider(input: CreateIdentityProviderInput, completion: @escaping (SdkResult<CreateIdentityProviderOutput, CreateIdentityProviderError>) -> Void)
    /// <p>Creates a new OAuth2.0 resource server and defines custom scopes in it.</p>
    func createResourceServer(input: CreateResourceServerInput, completion: @escaping (SdkResult<CreateResourceServerOutput, CreateResourceServerError>) -> Void)
    /// <p>Creates the user import job.</p>
    func createUserImportJob(input: CreateUserImportJobInput, completion: @escaping (SdkResult<CreateUserImportJobOutput, CreateUserImportJobError>) -> Void)
    /**
     <p>Creates a new Amazon Cognito user pool and sets the password policy for the
                 pool.</p>
     */
    func createUserPool(input: CreateUserPoolInput, completion: @escaping (SdkResult<CreateUserPoolOutput, CreateUserPoolError>) -> Void)
    /// <p>Creates the user pool client.</p>
    func createUserPoolClient(input: CreateUserPoolClientInput, completion: @escaping (SdkResult<CreateUserPoolClientOutput, CreateUserPoolClientError>) -> Void)
    /// <p>Creates a new domain for a user pool.</p>
    func createUserPoolDomain(input: CreateUserPoolDomainInput, completion: @escaping (SdkResult<CreateUserPoolDomainOutput, CreateUserPoolDomainError>) -> Void)
    /**
     <p>Deletes a group. Currently only groups with no members can be deleted.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func deleteGroup(input: DeleteGroupInput, completion: @escaping (SdkResult<DeleteGroupOutput, DeleteGroupError>) -> Void)
    /// <p>Deletes an identity provider for a user pool.</p>
    func deleteIdentityProvider(input: DeleteIdentityProviderInput, completion: @escaping (SdkResult<DeleteIdentityProviderOutput, DeleteIdentityProviderError>) -> Void)
    /// <p>Deletes a resource server.</p>
    func deleteResourceServer(input: DeleteResourceServerInput, completion: @escaping (SdkResult<DeleteResourceServerOutput, DeleteResourceServerError>) -> Void)
    /// <p>Allows a user to delete himself or herself.</p>
    func deleteUser(input: DeleteUserInput, completion: @escaping (SdkResult<DeleteUserOutput, DeleteUserError>) -> Void)
    /// <p>Deletes the attributes for a user.</p>
    func deleteUserAttributes(input: DeleteUserAttributesInput, completion: @escaping (SdkResult<DeleteUserAttributesOutput, DeleteUserAttributesError>) -> Void)
    /// <p>Deletes the specified Amazon Cognito user pool.</p>
    func deleteUserPool(input: DeleteUserPoolInput, completion: @escaping (SdkResult<DeleteUserPoolOutput, DeleteUserPoolError>) -> Void)
    /// <p>Allows the developer to delete the user pool client.</p>
    func deleteUserPoolClient(input: DeleteUserPoolClientInput, completion: @escaping (SdkResult<DeleteUserPoolClientOutput, DeleteUserPoolClientError>) -> Void)
    /// <p>Deletes a domain for a user pool.</p>
    func deleteUserPoolDomain(input: DeleteUserPoolDomainInput, completion: @escaping (SdkResult<DeleteUserPoolDomainOutput, DeleteUserPoolDomainError>) -> Void)
    /// <p>Gets information about a specific identity provider.</p>
    func describeIdentityProvider(input: DescribeIdentityProviderInput, completion: @escaping (SdkResult<DescribeIdentityProviderOutput, DescribeIdentityProviderError>) -> Void)
    /// <p>Describes a resource server.</p>
    func describeResourceServer(input: DescribeResourceServerInput, completion: @escaping (SdkResult<DescribeResourceServerOutput, DescribeResourceServerError>) -> Void)
    /// <p>Describes the risk configuration.</p>
    func describeRiskConfiguration(input: DescribeRiskConfigurationInput, completion: @escaping (SdkResult<DescribeRiskConfigurationOutput, DescribeRiskConfigurationError>) -> Void)
    /// <p>Describes the user import job.</p>
    func describeUserImportJob(input: DescribeUserImportJobInput, completion: @escaping (SdkResult<DescribeUserImportJobOutput, DescribeUserImportJobError>) -> Void)
    /// <p>Returns the configuration information and metadata of the specified user pool.</p>
    func describeUserPool(input: DescribeUserPoolInput, completion: @escaping (SdkResult<DescribeUserPoolOutput, DescribeUserPoolError>) -> Void)
    /**
     <p>Client method for returning the configuration information and metadata of the
                 specified user pool app client.</p>
     */
    func describeUserPoolClient(input: DescribeUserPoolClientInput, completion: @escaping (SdkResult<DescribeUserPoolClientOutput, DescribeUserPoolClientError>) -> Void)
    /// <p>Gets information about a domain.</p>
    func describeUserPoolDomain(input: DescribeUserPoolDomainInput, completion: @escaping (SdkResult<DescribeUserPoolDomainOutput, DescribeUserPoolDomainError>) -> Void)
    /// <p>Forgets the specified device.</p>
    func forgetDevice(input: ForgetDeviceInput, completion: @escaping (SdkResult<ForgetDeviceOutput, ForgetDeviceError>) -> Void)
    /**
     ...
     */
    func forgotPassword(input: ForgotPasswordInput, completion: @escaping (SdkResult<ForgotPasswordOutput, ForgotPasswordError>) -> Void)
    /**
     <p>Gets the header information for the .csv file to be used as input for the user import
                 job.</p>
     */
    func getCSVHeader(input: GetCSVHeaderInput, completion: @escaping (SdkResult<GetCSVHeaderOutput, GetCSVHeaderError>) -> Void)
    /// <p>Gets the device.</p>
    func getDevice(input: GetDeviceInput, completion: @escaping (SdkResult<GetDeviceOutput, GetDeviceError>) -> Void)
    /**
     <p>Gets a group.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func getGroup(input: GetGroupInput, completion: @escaping (SdkResult<GetGroupOutput, GetGroupError>) -> Void)
    /// <p>Gets the specified identity provider.</p>
    func getIdentityProviderByIdentifier(input: GetIdentityProviderByIdentifierInput, completion: @escaping (SdkResult<GetIdentityProviderByIdentifierOutput, GetIdentityProviderByIdentifierError>) -> Void)
    /// <p>This method takes a user pool ID, and returns the signing certificate.</p>
    func getSigningCertificate(input: GetSigningCertificateInput, completion: @escaping (SdkResult<GetSigningCertificateOutput, GetSigningCertificateError>) -> Void)
    /**
     ...
     */
    func getUICustomization(input: GetUICustomizationInput, completion: @escaping (SdkResult<GetUICustomizationOutput, GetUICustomizationError>) -> Void)
    /// <p>Gets the user attributes and metadata for a user.</p>
    func getUser(input: GetUserInput, completion: @escaping (SdkResult<GetUserOutput, GetUserError>) -> Void)
    /// <p>Gets the user attribute verification code for the specified attribute name.</p>
    func getUserAttributeVerificationCode(input: GetUserAttributeVerificationCodeInput, completion: @escaping (SdkResult<GetUserAttributeVerificationCodeOutput, GetUserAttributeVerificationCodeError>) -> Void)
    /// <p>Gets the user pool multi-factor authentication (MFA) configuration.</p>
    func getUserPoolMfaConfig(input: GetUserPoolMfaConfigInput, completion: @escaping (SdkResult<GetUserPoolMfaConfigOutput, GetUserPoolMfaConfigError>) -> Void)
    /**
     ...
     */
    func globalSignOut(input: GlobalSignOutInput, completion: @escaping (SdkResult<GlobalSignOutOutput, GlobalSignOutError>) -> Void)
    /// <p>Initiates the authentication flow.</p>
    func initiateAuth(input: InitiateAuthInput, completion: @escaping (SdkResult<InitiateAuthOutput, InitiateAuthError>) -> Void)
    /// <p>Lists the devices.</p>
    func listDevices(input: ListDevicesInput, completion: @escaping (SdkResult<ListDevicesOutput, ListDevicesError>) -> Void)
    /**
     <p>Lists the groups associated with a user pool.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func listGroups(input: ListGroupsInput, completion: @escaping (SdkResult<ListGroupsOutput, ListGroupsError>) -> Void)
    /// <p>Lists information about all identity providers for a user pool.</p>
    func listIdentityProviders(input: ListIdentityProvidersInput, completion: @escaping (SdkResult<ListIdentityProvidersOutput, ListIdentityProvidersError>) -> Void)
    /// <p>Lists the resource servers for a user pool.</p>
    func listResourceServers(input: ListResourceServersInput, completion: @escaping (SdkResult<ListResourceServersOutput, ListResourceServersError>) -> Void)
    /**
    ...
    func listUserImportJobs(input: ListUserImportJobsInput, completion: @escaping (SdkResult<ListUserImportJobsOutput, ListUserImportJobsError>) -> Void)
    /// <p>Lists the clients that have been created for the specified user pool.</p>
    func listUserPoolClients(input: ListUserPoolClientsInput, completion: @escaping (SdkResult<ListUserPoolClientsOutput, ListUserPoolClientsError>) -> Void)
    /// <p>Lists the user pools associated with an AWS account.</p>
    func listUserPools(input: ListUserPoolsInput, completion: @escaping (SdkResult<ListUserPoolsOutput, ListUserPoolsError>) -> Void)
    /// <p>Lists the users in the Amazon Cognito user pool.</p>
    func listUsers(input: ListUsersInput, completion: @escaping (SdkResult<ListUsersOutput, ListUsersError>) -> Void)
    /**
     <p>Lists the users in the specified group.</p>
             <p>Calling this action requires developer credentials.</p>
     */
    func listUsersInGroup(input: ListUsersInGroupInput, completion: @escaping (SdkResult<ListUsersInGroupOutput, ListUsersInGroupError>) -> Void)
    /**
     <p>Resends the confirmation (for confirmation of registration) to a specific user in the
                 user pool.</p>
     */
    func resendConfirmationCode(input: ResendConfirmationCodeInput, completion: @escaping (SdkResult<ResendConfirmationCodeOutput, ResendConfirmationCodeError>) -> Void)
    /// <p>Responds to the authentication challenge.</p>
    func respondToAuthChallenge(input: RespondToAuthChallengeInput, completion: @escaping (SdkResult<RespondToAuthChallengeOutput, RespondToAuthChallengeError>) -> Void)
    /**
     ...
     */
    func setRiskConfiguration(input: SetRiskConfigurationInput, completion: @escaping (SdkResult<SetRiskConfigurationOutput, SetRiskConfigurationError>) -> Void)
    /**
     ...
     */
    func setUICustomization(input: SetUICustomizationInput, completion: @escaping (SdkResult<SetUICustomizationOutput, SetUICustomizationError>) -> Void)
    /**
     ...
     */
    func setUserMFAPreference(input: SetUserMFAPreferenceInput, completion: @escaping (SdkResult<SetUserMFAPreferenceOutput, SetUserMFAPreferenceError>) -> Void)
    /// <p>Set the user pool multi-factor authentication (MFA) configuration.</p>
    func setUserPoolMfaConfig(input: SetUserPoolMfaConfigInput, completion: @escaping (SdkResult<SetUserPoolMfaConfigOutput, SetUserPoolMfaConfigError>) -> Void)
    /**
     <p>
                 <i>This action is no longer supported.</i> You can use it to configure
                 only SMS MFA. You can't use it to configure TOTP software token MFA. To configure either
     ...
     */
    func setUserSettings(input: SetUserSettingsInput, completion: @escaping (SdkResult<SetUserSettingsOutput, SetUserSettingsError>) -> Void)
    /**
     <p>Registers the user in the specified user pool and creates a user name, password, and
                 user attributes.</p>
     */
    func signUp(input: SignUpInput, completion: @escaping (SdkResult<SignUpOutput, SignUpError>) -> Void)
    /// <p>Starts the user import.</p>
    func startUserImportJob(input: StartUserImportJobInput, completion: @escaping (SdkResult<StartUserImportJobOutput, StartUserImportJobError>) -> Void)
    /// <p>Stops the user import job.</p>
    func stopUserImportJob(input: StopUserImportJobInput, completion: @escaping (SdkResult<StopUserImportJobOutput, StopUserImportJobError>) -> Void)
    /**
     ...
     */
    func updateAuthEventFeedback(input: UpdateAuthEventFeedbackInput, completion: @escaping (SdkResult<UpdateAuthEventFeedbackOutput, UpdateAuthEventFeedbackError>) -> Void)
    /// <p>Updates the device status.</p>
    func updateDeviceStatus(input: UpdateDeviceStatusInput, completion: @escaping (SdkResult<UpdateDeviceStatusOutput, UpdateDeviceStatusError>) -> Void)
    /**
     ...
     */
    func updateGroup(input: UpdateGroupInput, completion: @escaping (SdkResult<UpdateGroupOutput, UpdateGroupError>) -> Void)
    /// <p>Updates identity provider information for a user pool.</p>
    func updateIdentityProvider(input: UpdateIdentityProviderInput, completion: @escaping (SdkResult<UpdateIdentityProviderOutput, UpdateIdentityProviderError>) -> Void)
    /**
     ...
     */
    func updateResourceServer(input: UpdateResourceServerInput, completion: @escaping (SdkResult<UpdateResourceServerOutput, UpdateResourceServerError>) -> Void)
    /// <p>Allows a user to update a specific attribute (one at a time).</p>
    func updateUserAttributes(input: UpdateUserAttributesInput, completion: @escaping (SdkResult<UpdateUserAttributesOutput, UpdateUserAttributesError>) -> Void)
    /**
     ...
     */
    func updateUserPool(input: UpdateUserPoolInput, completion: @escaping (SdkResult<UpdateUserPoolOutput, UpdateUserPoolError>) -> Void)
    /**
     ...
     */
    func updateUserPoolClient(input: UpdateUserPoolClientInput, completion: @escaping (SdkResult<UpdateUserPoolClientOutput, UpdateUserPoolClientError>) -> Void)
    /**
     ...
     */
    func updateUserPoolDomain(input: UpdateUserPoolDomainInput, completion: @escaping (SdkResult<UpdateUserPoolDomainOutput, UpdateUserPoolDomainError>) -> Void)
    /**
     ...
     */
    func verifySoftwareToken(input: VerifySoftwareTokenInput, completion: @escaping (SdkResult<VerifySoftwareTokenOutput, VerifySoftwareTokenError>) -> Void)
    /// <p>Verifies the specified user attributes in the user pool.</p>
    func verifyUserAttribute(input: VerifyUserAttributeInput, completion: @escaping (SdkResult<VerifyUserAttributeOutput, VerifyUserAttributeError>) -> Void)
}
