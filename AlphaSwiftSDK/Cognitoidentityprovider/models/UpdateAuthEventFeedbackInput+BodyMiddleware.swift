...
public struct UpdateAuthEventFeedbackInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<UpdateAuthEventFeedbackOutput, UpdateAuthEventFeedbackError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<UpdateAuthEventFeedbackOutput, UpdateAuthEventFeedbackError>
