...
public struct GlobalSignOutInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<GlobalSignOutOutput, GlobalSignOutError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GlobalSignOutOutput, GlobalSignOutError>
