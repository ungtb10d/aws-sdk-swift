...
extension RiskExceptionConfigurationType: Codable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let blockedIPRangeList = blockedIPRangeList {
            var blockedIPRangeListContainer = container.nestedUnkeyedContainer(forKey: .blockedIPRangeList)
        ...
        if let skippedIPRangeList = skippedIPRangeList {
            var skippedIPRangeListContainer = container.nestedUnkeyedContainer(forKey: .skippedIPRangeList)
