...
extension AdminRespondToAuthChallengeOutput: HttpResponseBinding {
    public init (httpResponse: HttpResponse, decoder: ResponseDecoder? = nil) throws {

        if case .data(let data) = httpResponse.body,
            let unwrappedData = data,
            let responseDecoder = decoder {
            let output: AdminRespondToAuthChallengeOutputBody = try responseDecoder.decode(responseBody: unwrappedData)
