...
public struct DeleteUserPoolInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<DeleteUserPoolOutput, DeleteUserPoolError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteUserPoolOutput, DeleteUserPoolError>
