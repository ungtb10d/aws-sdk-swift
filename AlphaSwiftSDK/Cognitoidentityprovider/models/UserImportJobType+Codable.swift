...
extension UserImportJobType: Codable, Reflection {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let completionDate = completionDate {
            try container.encode(completionDate.timeIntervalSince1970, forKey: .completionDate)
        }
        ...
        if failedUsers != 0 {
            try container.encode(failedUsers, forKey: .failedUsers)
        }
        if importedUsers != 0 {
            try container.encode(importedUsers, forKey: .importedUsers)
        }
        if let jobId = jobId {
        ...
        if skippedUsers != 0 {
            try container.encode(skippedUsers, forKey: .skippedUsers)
        }
