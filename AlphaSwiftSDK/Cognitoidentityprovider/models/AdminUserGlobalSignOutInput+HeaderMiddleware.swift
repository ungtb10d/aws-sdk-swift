...
public struct AdminUserGlobalSignOutInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<AdminUserGlobalSignOutOutput, AdminUserGlobalSignOutError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AdminUserGlobalSignOutOutput, AdminUserGlobalSignOutError>
