...
public struct AdminRemoveUserFromGroupInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<AdminRemoveUserFromGroupOutput, AdminRemoveUserFromGroupError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AdminRemoveUserFromGroupOutput, AdminRemoveUserFromGroupError>
