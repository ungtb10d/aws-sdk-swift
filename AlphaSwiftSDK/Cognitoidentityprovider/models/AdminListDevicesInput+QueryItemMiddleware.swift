...
public struct AdminListDevicesInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<AdminListDevicesOutput, AdminListDevicesError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AdminListDevicesOutput, AdminListDevicesError>
