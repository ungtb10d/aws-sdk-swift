...
public struct GetIdentityPoolRolesInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Result<OperationOutput<GetIdentityPoolRolesOutput, GetIdentityPoolRolesError>, Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetIdentityPoolRolesOutput, GetIdentityPoolRolesError>
